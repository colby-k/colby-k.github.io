...
<p>
<strong>Custom Excel audit add-in for standardized tickmarks, workpaper formatting, references, review tools, and audit documentation support.</strong>
</p>
...
<div class="mini-case">
<p>
<strong>Status:</strong> In active development. The add-in is not publicly available yet, but this page will be used to share updates, screenshots, documentation, and future availability information.
</p>
</div>
