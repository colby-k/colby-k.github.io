const CACHE = "promptshelf-mobile-v019-rc4-folderaccordion2";
const APP_SHELL = [
  "./",
  "./index.html",
  ...
  "./icon-180.png",
  "./icon-192.png",
  "./rc4.css?v=folderaccordion2",
  "./rc4.js?v=folderaccordion2",
  "./rc4-favorite-hotfix.js?v=folderaccordion2",
  "./folder-accordion.css?v=folderaccordion2",
  "./folder-accordion.js?v=folderaccordion2"
];
...
function enhanceHtml(input) {
  ...
  if (html.includes('href="./rc4.css"')) {
    html = html.replace('href="./rc4.css"', 'href="./rc4.css?v=folderaccordion2"');
  } else if (!html.includes('href="./rc4.css?v=folderaccordion2"')) {
    html = html.replace("</head>", '<link rel="stylesheet" href="./rc4.css?v=folderaccordion2">\n</head>');
  }
  if (!html.includes('href="./folder-accordion.css?v=folderaccordion2"')) {
    html = html.replace("</head>", '<link rel="stylesheet" href="./folder-accordion.css?v=folderaccordion2">\n</head>');
  }
  if (html.includes('src="./rc4.js"')) {
    html = html.replace('src="./rc4.js"', 'src="./rc4.js?v=folderaccordion2"');
  } else if (!html.includes('src="./rc4.js?v=folderaccordion2"')) {
    html = html.replace("</body>", '<script src="./rc4.js?v=folderaccordion2"></script>\n</body>');
  }
  if (!html.includes('src="./rc4-favorite-hotfix.js?v=folderaccordion2"')) {
    html = html.replace("</body>", '<script src="./rc4-favorite-hotfix.js?v=folderaccordion2"></script>\n</body>');
  }
  if (!html.includes('src="./folder-accordion.js?v=folderaccordion2"')) {
    html = html.replace("</body>", '<script src="./folder-accordion.js?v=folderaccordion2"></script>\n</body>');
  }
  return html;
}
