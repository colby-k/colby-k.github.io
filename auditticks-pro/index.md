...
<section class="sp-section" id="workflow">
  ...
  <div class="atp-visual-grid">
    <article class="atp-visual-card">
      ...
      <div class="atp-visual-copy"><span>In-cell testing</span><h3>Standardize results without losing workpaper context.</h3><p>Passes, exceptions, N/A treatment, Vouched/Traced procedure marks, and legends stay directly in the testing matrix.</p></div>
    </article>
    ...
    <article class="atp-visual-card">
      ...
      <div class="atp-visual-copy"><span>Evidence tools</span><h3>Explain what matters on the evidence itself.</h3><p>Color-aware rectangles, selection-bound shapes, arrows, lines, and callouts keep the review trail clean and easy to follow.</p></div>
    </article>
    ...
    <article class="atp-visual-card atp-visual-card--wide">
      ...
      <div class="atp-visual-copy"><span>Review-ready workpaper</span><h3>Bring testing, support, signoff, and status together.</h3><p>Results, exception notes, references, worksheet links, preparer/reviewer identification, and tab-status cues sit together in one coherent Excel workpaper.</p></div>
    </article>
  </div>
</section>
...
<section class="sp-section sp-section--paper atp-capabilities">
  ...
  <div class="atp-feature-list" aria-label="AuditTicks feature summary">
    ...
    <span>Vouched &amp; Traced procedure marks</span>
    <span>References &amp; tie-outs</span>
    <span>Evidence figures &amp; callouts</span>
    <span>Link to Sheet</span>
    <span>Selection-aware shapes &amp; lines</span>
    <span>Testing structures &amp; legends</span>
    <span>Workpaper formatting &amp; themes</span>
    <span>Configurable keyboard shortcuts</span>
    <span>Shortcut quick-reference window</span>
    <span>Initials, dates &amp; tab status</span>
    <span>Macro-free XLSX export</span>
  </div>
